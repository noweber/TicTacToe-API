...
namespace RestClientSdkLibrary
{
    ...
    public partial class RestClientSdkLibraryClient : ServiceClient<RestClientSdkLibraryClient>, IRestClientSdkLibraryClient
    {
        ...
        {
            this.BaseUri = new Uri("http://localhost:2932");
        ...
        public async Task<HttpOperationResponse<object>> PostCalculateMoveWithHttpMessagesAsync(CalculateMoveRequest body = default(CalculateMoveRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "PostCalculateMove", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "CalculateMove").ToString();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<CalculateMoveResponse>(_responseContent, this.DeserializationSettings);
                }
        ...
        public async Task<HttpOperationResponse<object>> PostExecuteMoveWithHttpMessagesAsync(ExecuteMoveRequest body = default(ExecuteMoveRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("body", body);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "PostExecuteMove", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.BaseUri.AbsoluteUri;
